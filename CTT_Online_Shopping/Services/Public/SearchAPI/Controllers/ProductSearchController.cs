...
public class ProductSearchController : ControllerBase
{
                ...
                if (matchedFields.Contains("color") && productItem?.SizeColorVariant != null)
                {
                    ...
                    foreach (var variant in productItem.SizeColorVariant)
                    {
                        if (variant?.Color != null &&
                            colorMatched.Contains(variant.Color.Color, StringComparer.OrdinalIgnoreCase))
                        {
    ...
    private List<Dictionary<string, string>> FetchSubcategories(ProductItemEventModel productItem,
        List<string> matchedFields, List<string> matchedColor = null)
    {
